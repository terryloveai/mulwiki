    ...
    <main className="mx-auto max-w-2xl px-6 py-16">
      <div className="mb-10 flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-muted-foreground">Select a workspace or create a new one.</p>
        </div>
            ...
            <li key={workspace.id}>
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="truncate text-sm text-muted-foreground">{workspace.slug}</div>
                </div>
              </button>
            </li>
          ))}
